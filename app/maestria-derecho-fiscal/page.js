    ...
    <>
        ...
        <div className="intro-benefit-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"3rem", alignItems:"center", marginBottom:"3rem" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"1rem" }}>
            {[
              ...
              { num:"$7,300", label:"MXN/mes — Mensualidad después de beca + bono. Aplican restricciones.", color:"#7a2531" },
            ].map((m,i)=>(
      ...
      <section style={{ padding:"4rem 2rem", background:"#1a2744" }}>
        <div style={{ maxWidth:"1100px", margin:"0 auto", textAlign:"center" }}>
          ...
          <h2 style={{ fontFamily:"'Outfit',sans-serif", fontSize:"1.4rem", fontWeight:700, color:"#fff", marginBottom:"0.3rem" }}>Programa Cuatrimestral | 6 Cuatrimestres</h2>
            ...
            <div>
              ...
              <div style={{ marginTop:"1.2rem", padding:"1rem 1.2rem", background:"#f9f9f9", borderRadius:"10px", border:"1px solid #eee" }}>
                ...
                <p style={{ fontSize:"0.87rem", color:"#555", lineHeight:1.7, marginBottom:"0.3rem" }}>
                  <strong>Posgrados:</strong> Mensualidades desde <strong style={{ color:"#7a2531" }}>$7,300 MXN</strong> — Aplican restricciones.
                </p>
                <p style={{ fontSize:"0.71rem", color:"#aaa", lineHeight:1.5 }}>
                  *Mensualidades después de beca + bono. *Cuota considerando 2 materias.
                </p>
              </div>
            </div>
            {/* Testimonial mockup */}
      ...
      <section style={{ padding:"4rem 2rem", background:"#f9f9f9", borderTop:"3px solid #f59700" }}>
        <div style={{ maxWidth:"1200px", margin:"0 auto" }}>
          ...
          <p style={{ fontSize:"0.89rem", color:"#888", marginBottom:"0.5rem" }}>Programa Cuatrimestral · 6 Cuatrimestres · 2 años</p>
      ...
      <div style={{ textAlign:"center", padding:"2rem", background:"#f9f9f9" }}>
        <a href="/brochure-mdf.pdf" download target="_blank" rel="noopener noreferrer"
      ...
      <div className={`sticky-bar ${scrollY>400?"show":""}`}>
        <p style={{ fontFamily:"'Outfit',sans-serif", fontSize:"0.9rem", fontWeight:600, color:"#fff" }}>
          🎓 <strong>Maestría en Derecho Fiscal Online</strong> · <span style={{ color:"#f59700" }}>Beca + Bono disponibles</span>
        </p>
        <a href="#formulario">
